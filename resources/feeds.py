...
class RecentResourcesRss(Feed):
    title = "Recent Resources on sfvues"
    link = "/resource/"
    description = "Provides feed for recent resources shared on sfvue.com"
...
class TopicRecentResourcesRss(Feed):
    ...
    def description(self, obj):
        return "feed for recent resources shared on sfvue for %s" %obj.name
